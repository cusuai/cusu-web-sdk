...
const bg_aria_hide_chat = /** @type {(inputs: Aria_Hide_ChatInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Скриване на чата`)
};
...
const et_aria_hide_chat = /** @type {(inputs: Aria_Hide_ChatInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Peida vestlus`)
};
...
const lt_aria_hide_chat = /** @type {(inputs: Aria_Hide_ChatInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Slėpti pokalbį`)
};

const lv_aria_hide_chat = /** @type {(inputs: Aria_Hide_ChatInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Paslēpt tērzēšanu`)
};
...
const no_aria_hide_chat = /** @type {(inputs: Aria_Hide_ChatInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Skjul chatten`)
};
...
const sr_aria_hide_chat = /** @type {(inputs: Aria_Hide_ChatInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Sakrijte razgovor`)
};

const mk_aria_hide_chat = /** @type {(inputs: Aria_Hide_ChatInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Скријте го разговорот`)
};
...
*/
export const aria_hide_chat = /** @type {((inputs?: Aria_Hide_ChatInputs, options?: { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Aria_Hide_ChatInputs, { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "bg") return bg_aria_hide_chat(inputs)
	...
	if (locale === "et") return et_aria_hide_chat(inputs)
	...
	if (locale === "lt") return lt_aria_hide_chat(inputs)
	if (locale === "lv") return lv_aria_hide_chat(inputs)
	if (locale === "nl") return nl_aria_hide_chat(inputs)
	if (locale === "no") return no_aria_hide_chat(inputs)
	...
	if (locale === "sr") return sr_aria_hide_chat(inputs)
	if (locale === "mk") return mk_aria_hide_chat(inputs)
