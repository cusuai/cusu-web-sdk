...
*/
export const error_speech_failed = /** @type {((inputs?: Error_Speech_FailedInputs, options?: { locale?: "en" | "cs" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Error_Speech_FailedInputs, { locale?: "en" | "cs" }, {}>} */ ((inputs = {}, options = {}) => {
