...
const sr_aria_recording = /** @type {(inputs: Aria_RecordingInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Snimanje`)
};

const mk_aria_recording = /** @type {(inputs: Aria_RecordingInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Снимање`)
};
...
*/
export const aria_recording = /** @type {((inputs?: Aria_RecordingInputs, options?: { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Aria_RecordingInputs, { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "sr") return sr_aria_recording(inputs)
	if (locale === "mk") return mk_aria_recording(inputs)
