...
const sr_activity_search_pages = /** @type {(inputs: Activity_Search_PagesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pretražujem veb-sajt…`)
};

const mk_activity_search_pages = /** @type {(inputs: Activity_Search_PagesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ја пребарувам веб-страницата…`)
};
...
export const activity_search_pages = /** @type {((inputs?: Activity_Search_PagesInputs, options?: { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Activity_Search_PagesInputs, { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "sr") return sr_activity_search_pages(inputs)
	if (locale === "mk") return mk_activity_search_pages(inputs)
