...
const bg_error_mic_denied = /** @type {(inputs: Error_Mic_DeniedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Разрешете достъп до микрофона.`)
};
...
const et_error_mic_denied = /** @type {(inputs: Error_Mic_DeniedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Lubage juurdepääs mikrofonile.`)
};
...
const lt_error_mic_denied = /** @type {(inputs: Error_Mic_DeniedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Leiskite naudoti mikrofoną.`)
};

const lv_error_mic_denied = /** @type {(inputs: Error_Mic_DeniedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Atļaujiet piekļuvi mikrofonam.`)
};
...
const no_error_mic_denied = /** @type {(inputs: Error_Mic_DeniedInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tillat tilgang til mikrofonen.`)
};
...
*/
export const error_mic_denied = /** @type {((inputs?: Error_Mic_DeniedInputs, options?: { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "ro" | "sv" | "fi" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Error_Mic_DeniedInputs, { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "ro" | "sv" | "fi" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "bg") return bg_error_mic_denied(inputs)
	...
	if (locale === "et") return et_error_mic_denied(inputs)
	...
	if (locale === "lt") return lt_error_mic_denied(inputs)
	if (locale === "lv") return lv_error_mic_denied(inputs)
	if (locale === "nl") return nl_error_mic_denied(inputs)
	if (locale === "no") return no_error_mic_denied(inputs)
