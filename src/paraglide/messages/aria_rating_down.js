...
const bg_aria_rating_down = /** @type {(inputs: Aria_Rating_DownInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Не ми харесва`)
};
...
const et_aria_rating_down = /** @type {(inputs: Aria_Rating_DownInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Ei meeldi`)
};
...
const lt_aria_rating_down = /** @type {(inputs: Aria_Rating_DownInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Nepatinka`)
};

const lv_aria_rating_down = /** @type {(inputs: Aria_Rating_DownInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Nepatīk`)
};
...
const no_aria_rating_down = /** @type {(inputs: Aria_Rating_DownInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Tommel ned`)
};
...
const sr_aria_rating_down = /** @type {(inputs: Aria_Rating_DownInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Palac dole`)
};

const mk_aria_rating_down = /** @type {(inputs: Aria_Rating_DownInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Палец надолу`)
};
...
*/
export const aria_rating_down = /** @type {((inputs?: Aria_Rating_DownInputs, options?: { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Aria_Rating_DownInputs, { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "bg") return bg_aria_rating_down(inputs)
	...
	if (locale === "et") return et_aria_rating_down(inputs)
	...
	if (locale === "lt") return lt_aria_rating_down(inputs)
	if (locale === "lv") return lv_aria_rating_down(inputs)
	if (locale === "nl") return nl_aria_rating_down(inputs)
	if (locale === "no") return no_aria_rating_down(inputs)
	...
	if (locale === "sr") return sr_aria_rating_down(inputs)
	if (locale === "mk") return mk_aria_rating_down(inputs)
