...
const bg_error_reply_timeout = /** @type {(inputs: Error_Reply_TimeoutInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Не беше получен отговор. Опитайте отново.`)
};
...
const et_error_reply_timeout = /** @type {(inputs: Error_Reply_TimeoutInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Vastust ei saabunud. Proovige uuesti.`)
};
...
const lt_error_reply_timeout = /** @type {(inputs: Error_Reply_TimeoutInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Atsakymas negautas. Bandykite dar kartą.`)
};

const lv_error_reply_timeout = /** @type {(inputs: Error_Reply_TimeoutInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Atbilde netika saņemta. Mēģiniet vēlreiz.`)
};
...
const no_error_reply_timeout = /** @type {(inputs: Error_Reply_TimeoutInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Det kom ikke noe svar. Prøv igjen.`)
};
...
const sr_error_reply_timeout = /** @type {(inputs: Error_Reply_TimeoutInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Odgovor nije stigao. Pokušajte ponovo.`)
};

const mk_error_reply_timeout = /** @type {(inputs: Error_Reply_TimeoutInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Не пристигна одговор. Обидете се повторно.`)
};
...
export const error_reply_timeout = /** @type {((inputs?: Error_Reply_TimeoutInputs, options?: { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Error_Reply_TimeoutInputs, { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "et") return et_error_reply_timeout(inputs)
	...
	if (locale === "lt") return lt_error_reply_timeout(inputs)
	if (locale === "lv") return lv_error_reply_timeout(inputs)
	if (locale === "nl") return nl_error_reply_timeout(inputs)
	if (locale === "no") return no_error_reply_timeout(inputs)
	...
	if (locale === "sr") return sr_error_reply_timeout(inputs)
	if (locale === "mk") return mk_error_reply_timeout(inputs)
