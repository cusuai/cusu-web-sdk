...
const bg_aria_rating_star = /** @type {(inputs: Aria_Rating_StarInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Оценете с ${i?.star} от 5`)
};
...
const et_aria_rating_star = /** @type {(inputs: Aria_Rating_StarInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Hinda ${i?.star} punkti 5-st`)
};
...
const lt_aria_rating_star = /** @type {(inputs: Aria_Rating_StarInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Įvertinti ${i?.star} iš 5`)
};

const lv_aria_rating_star = /** @type {(inputs: Aria_Rating_StarInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Novērtēt ar ${i?.star} no 5`)
};
...
const no_aria_rating_star = /** @type {(inputs: Aria_Rating_StarInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Gi ${i?.star} av 5 stjerner`)
};
...
const sr_aria_rating_star = /** @type {(inputs: Aria_Rating_StarInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Izaberite ocenu ${i?.star} od 5`)
};

const mk_aria_rating_star = /** @type {(inputs: Aria_Rating_StarInputs) => LocalizedString} */ (i) => {
	return /** @type {LocalizedString} */ (`Изберете оцена ${i?.star} од 5`)
};
...
*/
export const aria_rating_star = /** @type {((inputs: Aria_Rating_StarInputs, options?: { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Aria_Rating_StarInputs, { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }, {}>} */ ((inputs, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "bg") return bg_aria_rating_star(inputs)
	...
	if (locale === "et") return et_aria_rating_star(inputs)
	...
	if (locale === "lt") return lt_aria_rating_star(inputs)
	if (locale === "lv") return lv_aria_rating_star(inputs)
	if (locale === "nl") return nl_aria_rating_star(inputs)
	if (locale === "no") return no_aria_rating_star(inputs)
	...
	if (locale === "sr") return sr_aria_rating_star(inputs)
	if (locale === "mk") return mk_aria_rating_star(inputs)
