...
const bg_activity_attach_link = /** @type {(inputs: Activity_Attach_LinkInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Прикачвам връзка…`)
};
...
const et_activity_attach_link = /** @type {(inputs: Activity_Attach_LinkInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Lisan linki…`)
};
...
const lt_activity_attach_link = /** @type {(inputs: Activity_Attach_LinkInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pridedama nuoroda…`)
};

const lv_activity_attach_link = /** @type {(inputs: Activity_Attach_LinkInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Pievieno saiti…`)
};
...
const no_activity_attach_link = /** @type {(inputs: Activity_Attach_LinkInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Legger ved en lenke…`)
};
...
export const activity_attach_link = /** @type {((inputs?: Activity_Attach_LinkInputs, options?: { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "ro" | "sv" | "fi" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Activity_Attach_LinkInputs, { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "ro" | "sv" | "fi" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "et") return et_activity_attach_link(inputs)
	...
	if (locale === "lt") return lt_activity_attach_link(inputs)
	if (locale === "lv") return lv_activity_attach_link(inputs)
	if (locale === "nl") return nl_activity_attach_link(inputs)
	if (locale === "no") return no_activity_attach_link(inputs)
