...
const sr_rating_prompt = /** @type {(inputs: Rating_PromptInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Kako smo se pokazali?`)
};

const mk_rating_prompt = /** @type {(inputs: Rating_PromptInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Како се покажавме?`)
};
...
*/
export const rating_prompt = /** @type {((inputs?: Rating_PromptInputs, options?: { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Rating_PromptInputs, { locale?: "en" | "bg" | "cs" | "sk" | "es" | "de" | "et" | "fr" | "pl" | "hu" | "it" | "lt" | "lv" | "nl" | "no" | "pt" | "da" | "sl" | "hr" | "sr" | "mk" | "ro" | "sv" | "fi" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "sr") return sr_rating_prompt(inputs)
	if (locale === "mk") return mk_rating_prompt(inputs)
