...
*/
export const rating_prompt = /** @type {((inputs?: Rating_PromptInputs, options?: { locale?: "en" | "cs" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Rating_PromptInputs, { locale?: "en" | "cs" }, {}>} */ ((inputs = {}, options = {}) => {
