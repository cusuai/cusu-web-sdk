...
*/
export const role_you = /** @type {((inputs?: Role_YouInputs, options?: { locale?: "en" | "cs" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Role_YouInputs, { locale?: "en" | "cs" }, {}>} */ ((inputs = {}, options = {}) => {
